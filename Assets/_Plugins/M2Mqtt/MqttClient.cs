...
namespace M2Mqtt
{
    ...
    public class MqttClient
    {
        ...
        private uPLibrary.Networking.M2Mqtt.MqttSettings settings;
        ...
        /// </summary>
        public uPLibrary.Networking.M2Mqtt.MqttSettings Settings
        {
        ...
        public MqttClient(IPAddress brokerIpAddress) :
            this(brokerIpAddress, uPLibrary.Networking.M2Mqtt.MqttSettings.MQTT_BROKER_DEFAULT_PORT, false, null, null, MqttSslProtocols.None)
        {
        }
...
#if !(WINDOWS_APP || WINDOWS_PHONE_APP || (!UNITY_EDITOR&&UNITY_WSA_10_0&&!ENABLE_IL2CPP))
            this(brokerHostName, uPLibrary.Networking.M2Mqtt.MqttSettings.MQTT_BROKER_DEFAULT_PORT, false, null, null, MqttSslProtocols.None)
#else
...
#endif
        {
            ...
            // reference to MQTT settings
            this.settings = uPLibrary.Networking.M2Mqtt.MqttSettings.Instance;
        ...
        {
            return this.SendReceive(msgBytes, uPLibrary.Networking.M2Mqtt.MqttSettings.MQTT_DEFAULT_TIMEOUT);
        }
        ...
        {
            return this.SendReceive(msg, uPLibrary.Networking.M2Mqtt.MqttSettings.MQTT_DEFAULT_TIMEOUT);
        }
