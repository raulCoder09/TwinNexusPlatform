...
namespace _Scripts.Controllers.MedaraVideosController
{
    ...
    public class MedaraVideosInfo
    {
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraVideosOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraVideosOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraVideosState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraVideosOps.PanelType CurrentActivePanel { get; set; } = IMedaraVideosOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraVideos";
            ...
            // Eventos de estado
            public event Action<IMedaraVideosOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraVideosOps.PanelType panelType)
            {
