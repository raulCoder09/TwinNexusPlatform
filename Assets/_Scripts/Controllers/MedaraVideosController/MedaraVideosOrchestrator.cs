...
namespace _Scripts.Controllers.MedaraVideosController
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraVideosOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraVideosOrchestrator : MonoBehaviour, IMedaraVideosOps, IUIController
    {
        ...
        public string ControllerName => "MedaraVideosController";
        ...
        #region IMedaraVideosOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraVideosOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraVideosOps.PanelType.None;

        // Events from IMedaraVideosOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraVideosOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraVideosInfo.UIConfiguration _uiConfig = new MedaraVideosInfo.UIConfiguration();
        private MedaraVideosInfo.AwsConfiguration _awsConfig = new MedaraVideosInfo.AwsConfiguration();
        private MedaraVideosInfo.MedaraVideosState _settingsState = new MedaraVideosInfo.MedaraVideosState();
        
        private MedaraVideosUIManager _uiManager;
        private MedaraVideosEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraVideosOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraVideosOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraVideosOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraVideosUIManager...");
                _uiManager = new MedaraVideosUIManager(_uiConfig);
                Debug.Log("MedaraVideosUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraVideosEventManager...");
                _eventManager = new MedaraVideosEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraVideosEventManager created successfully");
                ...
                InitializeMedaraVideosState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraVideosOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraVideosOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraVideosOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraVideosOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraVideosOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraVideosOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraVideosOps.PanelType panelType)
        {
        ...
        public void SwitchPanel(IMedaraVideosOps.PanelType fromPanel, IMedaraVideosOps.PanelType toPanel)
        {
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.NavigationMenu] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.AwsCredentials] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.ServiceConfig] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.TestResults] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.SecuritySettings] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.RegionSettings] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraVideosOps.PanelType.Help] = new MedaraVideosInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraVideosState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraVideos";
            _settingsState.CurrentActivePanel = IMedaraVideosOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraVideosInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraVideosOps.PanelType panelType)
        {
        ...
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, MedaraVideosInfo.ConnectionTestResult> results)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraVideosInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraVideosUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraVideosEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraVideosInfo.MedaraVideosState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraVideosInfo.AwsConfiguration AwsConfig => _awsConfig;
