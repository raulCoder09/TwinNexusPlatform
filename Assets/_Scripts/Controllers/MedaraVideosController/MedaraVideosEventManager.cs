...
namespace _Scripts.Controllers.MedaraVideosController
{
    ...
    /// </summary>
    public class MedaraVideosEventManager
    {
        private MedaraVideosUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraVideosOps.PanelType> _onPanelTransitionComplete;
        private MedaraVideosOrchestrator _orchestrator;
        ...
        public MedaraVideosEventManager(
            MedaraVideosUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraVideosOps.PanelType> onPanelTransitionComplete, 
            MedaraVideosOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraVideosEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraVideosEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraVideosEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraVideosEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraVideosEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraVideosEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraVideosOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraVideosOrchestrator Orchestrator => _orchestrator;
