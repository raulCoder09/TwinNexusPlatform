...
namespace _Scripts.Controllers.MedaraVideosController
{
    ...
    /// </summary>
    public class MedaraVideosUIManager
    {
        private MedaraVideosInfo.UIConfiguration _uiConfig;
        private IMedaraVideosOps.PanelType _currentActivePanel = IMedaraVideosOps.PanelType.None;
        ...
        public MedaraVideosUIManager(MedaraVideosInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[MedaraVideosUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[MedaraVideosUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[MedaraVideosUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IMedaraVideosOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IMedaraVideosOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[MedaraVideosUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IMedaraVideosOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[MedaraVideosUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IMedaraVideosOps.PanelType panelType)
        {
            if (panelType == IMedaraVideosOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IMedaraVideosOps.PanelType.None && 
                _currentActivePanel != IMedaraVideosOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[MedaraVideosUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IMedaraVideosOps.PanelType panelType)
        {
            if (panelType == IMedaraVideosOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[MedaraVideosUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IMedaraVideosOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IMedaraVideosOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IMedaraVideosOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[MedaraVideosUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraVideosUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraVideosUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IMedaraVideosOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[MedaraVideosUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IMedaraVideosOps.PanelType CurrentActivePanel => _currentActivePanel;
