...
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IAwsSettingsOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class AwsSettingsOrchestrator : MonoBehaviour, IAwsSettingsOps, IUIController
    {
        ...
        public string ControllerName => "AwsSettingsController";
        ...
        #region IAwsSettingsOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IAwsSettingsOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IAwsSettingsOps.PanelType.None;

        // Events from IAwsSettingsOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IAwsSettingsOps.PanelType> OnPanelTransitionComplete;
        ...
        private AwsSettingsInfo.UIConfiguration _uiConfig = new AwsSettingsInfo.UIConfiguration();
        private AwsSettingsInfo.AwsConfiguration _awsConfig = new AwsSettingsInfo.AwsConfiguration();
        private AwsSettingsInfo.AwsSettingsState _settingsState = new AwsSettingsInfo.AwsSettingsState();
        
        private AwsSettingsUIManager _uiManager;
        private AwsSettingsEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[AwsSettingsOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("AwsSettingsOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing AwsSettingsOrchestrator...");
                ...
                Debug.Log("Step 5: Creating AwsSettingsUIManager...");
                _uiManager = new AwsSettingsUIManager(_uiConfig);
                Debug.Log("AwsSettingsUIManager created successfully");

                Debug.Log("Step 6: Creating AwsSettingsEventManager...");
                _eventManager = new AwsSettingsEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("AwsSettingsEventManager created successfully");
                ...
                InitializeAwsSettingsState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("AwsSettingsOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"AwsSettingsOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[AwsSettingsOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[AwsSettingsOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[AwsSettingsOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[AwsSettingsOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IAwsSettingsOps.PanelType panelType)
        {
        ...
        public void SwitchPanel(IAwsSettingsOps.PanelType fromPanel, IAwsSettingsOps.PanelType toPanel)
        {
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.NavigationMenu] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.AwsCredentials] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.ServiceConfig] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.TestResults] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.SecuritySettings] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.RegionSettings] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IAwsSettingsOps.PanelType.Help] = new AwsSettingsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeAwsSettingsState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "AwsSettings";
            _settingsState.CurrentActivePanel = IAwsSettingsOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, AwsSettingsInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IAwsSettingsOps.PanelType panelType)
        {
        ...
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, AwsSettingsInfo.ConnectionTestResult> results)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new AwsSettingsInfo.ConnectionTestResult
            {
        ...
        /// </summary>
        public AwsSettingsEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public AwsSettingsInfo.AwsSettingsState SettingsState => _settingsState;
