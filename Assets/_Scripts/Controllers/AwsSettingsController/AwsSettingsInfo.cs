...
namespace _Scripts.Controllers.AwsSettingsController
{
    ...
    public class AwsSettingsInfo
    {
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IAwsSettingsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IAwsSettingsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class AwsSettingsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IAwsSettingsOps.PanelType CurrentActivePanel { get; set; } = IAwsSettingsOps.PanelType.None;
            public string CurrentSection { get; set; } = "AwsSettings";
            ...
            // Eventos de estado
            public event Action<IAwsSettingsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IAwsSettingsOps.PanelType panelType)
            {
