...
namespace _Scripts.Controllers.AwsSettingsController
{
    ...
    /// </summary>
    public class AwsSettingsUIManager
    {
        private AwsSettingsInfo.UIConfiguration _uiConfig;
        private IAwsSettingsOps.PanelType _currentActivePanel = IAwsSettingsOps.PanelType.None;
        ...
        public AwsSettingsUIManager(AwsSettingsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[AwsSettingsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[AwsSettingsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[AwsSettingsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IAwsSettingsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IAwsSettingsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[AwsSettingsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IAwsSettingsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[AwsSettingsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IAwsSettingsOps.PanelType panelType)
        {
            if (panelType == IAwsSettingsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IAwsSettingsOps.PanelType.None && 
                _currentActivePanel != IAwsSettingsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[AwsSettingsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IAwsSettingsOps.PanelType panelType)
        {
            if (panelType == IAwsSettingsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[AwsSettingsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IAwsSettingsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IAwsSettingsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IAwsSettingsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[AwsSettingsUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[AwsSettingsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[AwsSettingsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IAwsSettingsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[AwsSettingsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IAwsSettingsOps.PanelType CurrentActivePanel => _currentActivePanel;
