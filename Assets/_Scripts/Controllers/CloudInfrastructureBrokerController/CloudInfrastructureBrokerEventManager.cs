...
{
    /// <summary>
    /// Maneja todos los eventos UI del CloudInfrastructureBroker
    /// Equivalente a WelcomeEventManager pero para CloudInfrastructureBroker
    /// </summary>
    public class CloudInfrastructureBrokerEventManager
    {
        private CloudInfrastructureBrokerUIManager _uiManager;
        private Action _onLogoutRequested;
        private Action<ICloudInfrastructureBrokerOps.PanelType> _onPanelTransitionComplete;
        private CloudInfrastructureBrokerOrchestrator _orchestrator;
        ...
        public CloudInfrastructureBrokerEventManager(
            CloudInfrastructureBrokerUIManager uiManager, 
            Action onLogoutRequested, 
            Action<ICloudInfrastructureBrokerOps.PanelType> onPanelTransitionComplete, 
            CloudInfrastructureBrokerOrchestrator orchestrator)
        {
        ...
        /// <summary>
        /// Registra todos los eventos del CloudInfrastructureBroker
        /// </summary>
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[CloudInfrastructureBrokerEventManager] All events registered successfully");
        }

        /// <summary>
        /// Desregistra todos los eventos del CloudInfrastructureBroker
        /// </summary>
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[CloudInfrastructureBrokerEventManager] Unregistering CloudInfrastructureBroker events...");

                if (_root == null)
                {
                    Debug.LogWarning("[CloudInfrastructureBrokerEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[CloudInfrastructureBrokerEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[CloudInfrastructureBrokerEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[CloudInfrastructureBrokerEventManager] Event Manager cleaned up");
        }
        ...
        /// <summary>
        /// Registra eventos de teclado para el CloudInfrastructureBroker
        /// </summary>
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != ICloudInfrastructureBrokerOps.PanelType.None)
            {
        ...
        private async void OnMenuButtonClicked(ClickEvent evt)
        {
            ...
            await UIAnalyticsManager.Instance?.TrackMenuEvent(
                action: "menu_opened",
                menuItem: null,
                context: "CloudInfrastructureBroker_main"
            );
        }
        ...
        {
            _uiManager.ShowPanel(ICloudInfrastructureBrokerOps.PanelType.Notifications);
            await UIAnalyticsManager.Instance?.TrackPanelTransition(
                fromPanel: "CloudInfrastructureBroker_main",
        ...
        {
            _uiManager.ShowPanel(ICloudInfrastructureBrokerOps.PanelType.UserProfile);
        }
        ...
        {
            _uiManager.ShowPanel(ICloudInfrastructureBrokerOps.PanelType.QuickActions);
        }
        ...
        {
            _uiManager.ShowPanel(ICloudInfrastructureBrokerOps.PanelType.StatusOverlay);
        }
        ...
        {
            _uiManager.HidePanel(ICloudInfrastructureBrokerOps.PanelType.Notifications);
            await UIAnalyticsManager.Instance?.TrackPanelTransition(
        ...
        {
            _uiManager.HidePanel(ICloudInfrastructureBrokerOps.PanelType.UserProfile);
        }
        ...
        {
            _uiManager.HidePanel(ICloudInfrastructureBrokerOps.PanelType.QuickActions);
        }
        ...
        {
            _uiManager.HidePanel(ICloudInfrastructureBrokerOps.PanelType.StatusOverlay);
        }
        ...
        /// </summary>
        public CloudInfrastructureBrokerOrchestrator Orchestrator => _orchestrator;
