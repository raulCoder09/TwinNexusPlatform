...
{
    /// <summary>
    /// Coordinador principal del CloudInfrastructureBroker - implementa ICloudInfrastructureBrokerOps e IUIController
    /// Equivalente a WelcomeOrchestrator pero para CloudInfrastructureBroker
    /// </summary>
    public class CloudInfrastructureBrokerOrchestrator : MonoBehaviour, ICloudInfrastructureBrokerOps, IUIController
    {
        #region IUIController Implementation

        public bool RequiresAuthentication => true; // CloudInfrastructureBroker SÍ requiere autenticación
        public bool IsInitialized => _isInitialized;
        public bool IsActive => _uiConfig?.Body?.style.display == DisplayStyle.Flex;
        public string ControllerName => "CloudInfrastructureBrokerController";
        ...
        #region ICloudInfrastructureBrokerOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public ICloudInfrastructureBrokerOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? ICloudInfrastructureBrokerOps.PanelType.None;

        // Events from ICloudInfrastructureBrokerOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<ICloudInfrastructureBrokerOps.PanelType> OnPanelTransitionComplete;
        public event Action OnLogoutRequested;
        public event Action<CloudInfrastructureBrokerInfo.ConnectionStatus, CloudInfrastructureBrokerInfo.ConnectionStatus, CloudInfrastructureBrokerInfo.ConnectionStatus> OnIoTStatusChanged;

        #endregion

        #region Private Fields

        private CloudInfrastructureBrokerInfo.UIConfiguration _uiConfig = new CloudInfrastructureBrokerInfo.UIConfiguration();
        private CloudInfrastructureBrokerInfo.UserData _userData = new CloudInfrastructureBrokerInfo.UserData();
        private CloudInfrastructureBrokerInfo.CloudInfrastructureBrokerState _CloudInfrastructureBrokerState = new CloudInfrastructureBrokerInfo.CloudInfrastructureBrokerState();
        
        private CloudInfrastructureBrokerUIManager _uiManager;
        private CloudInfrastructureBrokerEventManager _eventManager;
        ...
        private void Start()
        {
            // CRÍTICO: CloudInfrastructureBroker inicia OCULTO hasta autenticación
            HideUi();
            _subpanelsAndSmokeMaskContainer.style.display = DisplayStyle.None;
            
            Debug.Log("[CloudInfrastructureBrokerOrchestrator] Started - UI hidden until authentication");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("CloudInfrastructureBrokerOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing CloudInfrastructureBrokerOrchestrator...");
                ...
                _uiManager = new CloudInfrastructureBrokerUIManager(_uiConfig);
                _eventManager = new CloudInfrastructureBrokerEventManager(_uiManager, OnLogoutRequestedHandler, OnPanelTransitionCompleteHandler, this);
                ...
                // Inicializar estado
                InitializeCloudInfrastructureBrokerState();

                // Suscribirse a eventos de ServiceController
                SubscribeToServiceControllerEvents();

                _isInitialized = true;
                Debug.Log("✅ CloudInfrastructureBrokerOrchestrator initialized successfully");
                OnControllerInitialized?.Invoke(this);
                return true;
            }
            catch (Exception ex)
            {
                Debug.LogError($"CloudInfrastructureBrokerOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            {
                Debug.LogError("Cannot show CloudInfrastructureBroker - user not authenticated");
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[CloudInfrastructureBrokerOrchestrator] CloudInfrastructureBroker UI shown");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                _uiConfig = null;
                _userData = null;
                _CloudInfrastructureBrokerState = null;
                _uiDocument = null;
            ...
            {
                Debug.LogError($"[CloudInfrastructureBrokerOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(ICloudInfrastructureBrokerOps.PanelType panelType)
        {
        ...
        public void HandleReportsClick()
        {
            ...
            // Cerrar menú y ocultar CloudInfrastructureBroker
            _uiManager?.HideNavigationMenu();
            Hide();
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "CloudInfrastructureBroker"
            };
        ...
        /// <summary>
        /// Obtiene componentes UI del CloudInfrastructureBroker
        /// </summary>
        private void GetUiComponents(VisualElement root)
        {
            ...
            Debug.Log("✅ CloudInfrastructureBroker UI components obtained successfully");
        }
...
private void InitializePanelConfiguration(VisualElement root)
{
    ...
    _uiConfig.Panels[ICloudInfrastructureBrokerOps.PanelType.NavigationMenu] = new CloudInfrastructureBrokerInfo.UIConfiguration.PanelData
    {
    ...
    _uiConfig.Panels[ICloudInfrastructureBrokerOps.PanelType.Notifications] = new CloudInfrastructureBrokerInfo.UIConfiguration.PanelData
    {
    ...
    _uiConfig.Panels[ICloudInfrastructureBrokerOps.PanelType.UserProfile] = new CloudInfrastructureBrokerInfo.UIConfiguration.PanelData
    {
        Panel = null, // 👈 SERÁ NULL porque no existe en UXML
    ...
    _uiConfig.Panels[ICloudInfrastructureBrokerOps.PanelType.QuickActions] = new CloudInfrastructureBrokerInfo.UIConfiguration.PanelData
    {
        Panel = null, // 👈 SERÁ NULL porque no existe en UXML
    ...
    _uiConfig.Panels[ICloudInfrastructureBrokerOps.PanelType.StatusOverlay] = new CloudInfrastructureBrokerInfo.UIConfiguration.PanelData
    {
        Panel = null, // 👈 SERÁ NULL porque no existe en UXML
    ...
    foreach (var kvp in _uiConfig.Panels)
    {
        ...
        private void FindDependencies()
        {
            ...
            Debug.Log("CloudInfrastructureBroker dependencies search completed");
        }

        /// <summary>
        /// Inicializa el estado del CloudInfrastructureBroker
        /// </summary>
        private void InitializeCloudInfrastructureBrokerState()
        {
            _CloudInfrastructureBrokerState.IsInitialized = true;
            _CloudInfrastructureBrokerState.CurrentSection = "CloudInfrastructureBroker";
            _CloudInfrastructureBrokerState.CurrentActivePanel = ICloudInfrastructureBrokerOps.PanelType.None;
            
            // Inicializar estados de IoT
            _CloudInfrastructureBrokerState.LocalIoTStatus = CloudInfrastructureBrokerInfo.ConnectionStatus.Unknown;
            _CloudInfrastructureBrokerState.VMIoTStatus = CloudInfrastructureBrokerInfo.ConnectionStatus.Unknown;
            _CloudInfrastructureBrokerState.CloudIoTStatus = CloudInfrastructureBrokerInfo.ConnectionStatus.Unknown;
            
            Debug.Log("CloudInfrastructureBroker state initialized");
        }
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(ICloudInfrastructureBrokerOps.PanelType panelType)
        {
        ...
        {
            _CloudInfrastructureBrokerState.LocalIoTStatus = localStatus;
            _CloudInfrastructureBrokerState.VMIoTStatus = vmStatus;
            _CloudInfrastructureBrokerState.CloudIoTStatus = cloudStatus;
        ...
        /// UI Manager asociado
        /// </summary>
        public CloudInfrastructureBrokerUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public CloudInfrastructureBrokerEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual del CloudInfrastructureBroker
        /// </summary>
        public CloudInfrastructureBrokerInfo.CloudInfrastructureBrokerState CloudInfrastructureBrokerState => _CloudInfrastructureBrokerState;

        /// <summary>
        /// Datos del usuario actual
        /// </summary>
        public CloudInfrastructureBrokerInfo.UserData UserData => _userData;
