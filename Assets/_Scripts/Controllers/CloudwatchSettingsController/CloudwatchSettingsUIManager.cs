...
namespace _Scripts.Controllers.CloudwatchSettingsController
{
    ...
    /// </summary>
    public class CloudwatchSettingsUIManager
    {
        private CloudwatchSettingsInfo.UIConfiguration _uiConfig;
        private ICloudwatchSettingsOps.PanelType _currentActivePanel = ICloudwatchSettingsOps.PanelType.None;
        ...
        public CloudwatchSettingsUIManager(CloudwatchSettingsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[CloudwatchSettingsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[CloudwatchSettingsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[CloudwatchSettingsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(ICloudwatchSettingsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = ICloudwatchSettingsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[CloudwatchSettingsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = ICloudwatchSettingsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[CloudwatchSettingsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(ICloudwatchSettingsOps.PanelType panelType)
        {
            if (panelType == ICloudwatchSettingsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != ICloudwatchSettingsOps.PanelType.None && 
                _currentActivePanel != ICloudwatchSettingsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[CloudwatchSettingsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(ICloudwatchSettingsOps.PanelType panelType)
        {
            if (panelType == ICloudwatchSettingsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[CloudwatchSettingsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != ICloudwatchSettingsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != ICloudwatchSettingsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(ICloudwatchSettingsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[CloudwatchSettingsUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[CloudwatchSettingsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[CloudwatchSettingsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != ICloudwatchSettingsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[CloudwatchSettingsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public ICloudwatchSettingsOps.PanelType CurrentActivePanel => _currentActivePanel;
