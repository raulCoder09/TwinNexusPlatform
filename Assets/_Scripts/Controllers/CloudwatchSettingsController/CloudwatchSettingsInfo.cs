...
namespace _Scripts.Controllers.CloudwatchSettingsController
{
    ...
    /// </summary>
    [System.Serializable]
    public class CloudwatchSettingsInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<ICloudwatchSettingsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<ICloudwatchSettingsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class CloudwatchSettingsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public ICloudwatchSettingsOps.PanelType CurrentActivePanel { get; set; } = ICloudwatchSettingsOps.PanelType.None;
            public string CurrentSection { get; set; } = "CloudwatchSettings";
            ...
            // Eventos de estado
            public event Action<ICloudwatchSettingsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(ICloudwatchSettingsOps.PanelType panelType)
            {
