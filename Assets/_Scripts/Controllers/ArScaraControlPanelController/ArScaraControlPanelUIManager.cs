...
namespace _Scripts.Controllers.ArScaraControlPanelController
{
    ...
    /// </summary>
    public class ArScaraControlPanelUIManager
    {
        private ArScaraControlPanelInfo.UIConfiguration _uiConfig;
        private IArScaraControlPanelOps.PanelType _currentActivePanel = IArScaraControlPanelOps.PanelType.None;
        ...
        public ArScaraControlPanelUIManager(ArScaraControlPanelInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[ArScaraControlPanelUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[ArScaraControlPanelUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[ArScaraControlPanelUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IArScaraControlPanelOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IArScaraControlPanelOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[ArScaraControlPanelUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IArScaraControlPanelOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[ArScaraControlPanelUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IArScaraControlPanelOps.PanelType panelType)
        {
            if (panelType == IArScaraControlPanelOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IArScaraControlPanelOps.PanelType.None && 
                _currentActivePanel != IArScaraControlPanelOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[ArScaraControlPanelUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IArScaraControlPanelOps.PanelType panelType)
        {
            if (panelType == IArScaraControlPanelOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[ArScaraControlPanelUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IArScaraControlPanelOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IArScaraControlPanelOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IArScaraControlPanelOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[ArScaraControlPanelUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[ArScaraControlPanelUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[ArScaraControlPanelUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IArScaraControlPanelOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[ArScaraControlPanelUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IArScaraControlPanelOps.PanelType CurrentActivePanel => _currentActivePanel;
