...
namespace _Scripts.Controllers.ArScaraControlPanelController
{
    ...
    /// </summary>
    [System.Serializable]
    public class ArScaraControlPanelInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IArScaraControlPanelOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IArScaraControlPanelOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class ArScaraControlPanelState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IArScaraControlPanelOps.PanelType CurrentActivePanel { get; set; } = IArScaraControlPanelOps.PanelType.None;
            public string CurrentSection { get; set; } = "ArScaraControlPanel";
            ...
            // Eventos de estado
            public event Action<IArScaraControlPanelOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IArScaraControlPanelOps.PanelType panelType)
            {
