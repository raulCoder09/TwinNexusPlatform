...
namespace _Scripts.Controllers.MedaraInteractiveSimulatorController
{
    ...
    /// </summary>
    public class MedaraInteractiveSimulatorEventManager
    {
        private MedaraInteractiveSimulatorUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraInteractiveSimulatorOps.PanelType> _onPanelTransitionComplete;
        private MedaraInteractiveSimulatorOrchestrator _orchestrator;
        ...
        public MedaraInteractiveSimulatorEventManager(
            MedaraInteractiveSimulatorUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraInteractiveSimulatorOps.PanelType> onPanelTransitionComplete, 
            MedaraInteractiveSimulatorOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraInteractiveSimulatorEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraInteractiveSimulatorEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraInteractiveSimulatorEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraInteractiveSimulatorEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraInteractiveSimulatorEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraInteractiveSimulatorEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraInteractiveSimulatorOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraInteractiveSimulatorOrchestrator Orchestrator => _orchestrator;
