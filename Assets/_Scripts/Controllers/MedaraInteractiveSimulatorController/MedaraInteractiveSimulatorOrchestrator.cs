...
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraInteractiveSimulatorOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraInteractiveSimulatorOrchestrator : MonoBehaviour, IMedaraInteractiveSimulatorOps, IUIController
    {
        ...
        public string ControllerName => "MedaraInteractiveSimulatorController";
        ...
        #region IMedaraInteractiveSimulatorOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraInteractiveSimulatorOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraInteractiveSimulatorOps.PanelType.None;

        // Events from IMedaraInteractiveSimulatorOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraInteractiveSimulatorOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraInteractiveSimulatorInfo.UIConfiguration _uiConfig = new MedaraInteractiveSimulatorInfo.UIConfiguration();
        private MedaraInteractiveSimulatorInfo.AwsConfiguration _awsConfig = new MedaraInteractiveSimulatorInfo.AwsConfiguration();
        private MedaraInteractiveSimulatorInfo.MedaraInteractiveSimulatorState _settingsState = new MedaraInteractiveSimulatorInfo.MedaraInteractiveSimulatorState();
        
        private MedaraInteractiveSimulatorUIManager _uiManager;
        private MedaraInteractiveSimulatorEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraInteractiveSimulatorOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraInteractiveSimulatorOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraInteractiveSimulatorOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraInteractiveSimulatorUIManager...");
                _uiManager = new MedaraInteractiveSimulatorUIManager(_uiConfig);
                Debug.Log("MedaraInteractiveSimulatorUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraInteractiveSimulatorEventManager...");
                _eventManager = new MedaraInteractiveSimulatorEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraInteractiveSimulatorEventManager created successfully");
                ...
                InitializeMedaraInteractiveSimulatorState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraInteractiveSimulatorOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraInteractiveSimulatorOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraInteractiveSimulatorOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraInteractiveSimulatorOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraInteractiveSimulatorOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraInteractiveSimulatorOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraInteractiveSimulatorOps.PanelType panelType)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "MedaraInteractiveSimulator"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.NavigationMenu] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.AwsCredentials] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.ServiceConfig] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.TestResults] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.SecuritySettings] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.RegionSettings] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInteractiveSimulatorOps.PanelType.Help] = new MedaraInteractiveSimulatorInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraInteractiveSimulatorState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraInteractiveSimulator";
            _settingsState.CurrentActivePanel = IMedaraInteractiveSimulatorOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraInteractiveSimulatorInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraInteractiveSimulatorOps.PanelType panelType)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraInteractiveSimulatorInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraInteractiveSimulatorUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraInteractiveSimulatorEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraInteractiveSimulatorInfo.MedaraInteractiveSimulatorState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraInteractiveSimulatorInfo.AwsConfiguration AwsConfig => _awsConfig;
