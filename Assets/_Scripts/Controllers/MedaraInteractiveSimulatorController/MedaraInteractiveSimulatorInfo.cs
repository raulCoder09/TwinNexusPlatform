...
namespace _Scripts.Controllers.MedaraInteractiveSimulatorController
{
    ...
    /// </summary>
    [System.Serializable]
    public class MedaraInteractiveSimulatorInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraInteractiveSimulatorOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraInteractiveSimulatorOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraInteractiveSimulatorState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraInteractiveSimulatorOps.PanelType CurrentActivePanel { get; set; } = IMedaraInteractiveSimulatorOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraInteractiveSimulator";
            ...
            // Eventos de estado
            public event Action<IMedaraInteractiveSimulatorOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraInteractiveSimulatorOps.PanelType panelType)
            {
