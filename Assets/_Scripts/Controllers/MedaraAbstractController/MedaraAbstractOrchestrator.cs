...
namespace _Scripts.Controllers.MedaraAbstractController
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraAbstractOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraAbstractOrchestrator : MonoBehaviour, IMedaraAbstractOps, IUIController
    {
        ...
        public string ControllerName => "MedaraAbstractController";
        ...
        #region IMedaraAbstractOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraAbstractOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraAbstractOps.PanelType.None;

        // Events from IMedaraAbstractOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraAbstractOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraAbstractInfo.UIConfiguration _uiConfig = new MedaraAbstractInfo.UIConfiguration();
        private MedaraAbstractInfo.AwsConfiguration _awsConfig = new MedaraAbstractInfo.AwsConfiguration();
        private MedaraAbstractInfo.MedaraAbstractState _settingsState = new MedaraAbstractInfo.MedaraAbstractState();
        
        private MedaraAbstractUIManager _uiManager;
        private MedaraAbstractEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraAbstractOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraAbstractOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraAbstractOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraAbstractUIManager...");
                _uiManager = new MedaraAbstractUIManager(_uiConfig);
                Debug.Log("MedaraAbstractUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraAbstractEventManager...");
                _eventManager = new MedaraAbstractEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraAbstractEventManager created successfully");
                ...
                InitializeMedaraAbstractState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraAbstractOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraAbstractOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraAbstractOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraAbstractOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraAbstractOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraAbstractOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraAbstractOps.PanelType panelType)
        {
        ...
        public void SwitchPanel(IMedaraAbstractOps.PanelType fromPanel, IMedaraAbstractOps.PanelType toPanel)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "MedaraAbstract"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.NavigationMenu] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.AwsCredentials] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.ServiceConfig] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.TestResults] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.SecuritySettings] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.RegionSettings] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraAbstractOps.PanelType.Help] = new MedaraAbstractInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraAbstractState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraAbstract";
            _settingsState.CurrentActivePanel = IMedaraAbstractOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraAbstractInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraAbstractOps.PanelType panelType)
        {
        ...
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, MedaraAbstractInfo.ConnectionTestResult> results)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraAbstractInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraAbstractUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraAbstractEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraAbstractInfo.MedaraAbstractState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraAbstractInfo.AwsConfiguration AwsConfig => _awsConfig;
