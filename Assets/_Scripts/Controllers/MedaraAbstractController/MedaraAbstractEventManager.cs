...
namespace _Scripts.Controllers.MedaraAbstractController
{
    ...
    /// </summary>
    public class MedaraAbstractEventManager
    {
        private MedaraAbstractUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraAbstractOps.PanelType> _onPanelTransitionComplete;
        private MedaraAbstractOrchestrator _orchestrator;
        ...
        public MedaraAbstractEventManager(
            MedaraAbstractUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraAbstractOps.PanelType> onPanelTransitionComplete, 
            MedaraAbstractOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraAbstractEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraAbstractEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraAbstractEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraAbstractEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraAbstractEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraAbstractEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraAbstractOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraAbstractOrchestrator Orchestrator => _orchestrator;
