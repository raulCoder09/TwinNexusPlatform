...
namespace _Scripts.Controllers.MedaraAbstractController
{
    ...
    /// </summary>
    [System.Serializable]
    public class MedaraAbstractInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraAbstractOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraAbstractOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraAbstractState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraAbstractOps.PanelType CurrentActivePanel { get; set; } = IMedaraAbstractOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraAbstract";
            ...
            // Eventos de estado
            public event Action<IMedaraAbstractOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraAbstractOps.PanelType panelType)
            {
