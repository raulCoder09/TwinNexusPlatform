...
namespace _Scripts.Controllers.MedaraAbstractController
{
    ...
    /// </summary>
    public class MedaraAbstractUIManager
    {
        private MedaraAbstractInfo.UIConfiguration _uiConfig;
        private IMedaraAbstractOps.PanelType _currentActivePanel = IMedaraAbstractOps.PanelType.None;
        ...
        public MedaraAbstractUIManager(MedaraAbstractInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[MedaraAbstractUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[MedaraAbstractUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[MedaraAbstractUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IMedaraAbstractOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IMedaraAbstractOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[MedaraAbstractUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IMedaraAbstractOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[MedaraAbstractUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IMedaraAbstractOps.PanelType panelType)
        {
            if (panelType == IMedaraAbstractOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IMedaraAbstractOps.PanelType.None && 
                _currentActivePanel != IMedaraAbstractOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[MedaraAbstractUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IMedaraAbstractOps.PanelType panelType)
        {
            if (panelType == IMedaraAbstractOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[MedaraAbstractUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IMedaraAbstractOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IMedaraAbstractOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IMedaraAbstractOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[MedaraAbstractUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraAbstractUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraAbstractUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IMedaraAbstractOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[MedaraAbstractUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IMedaraAbstractOps.PanelType CurrentActivePanel => _currentActivePanel;
