...
namespace _Scripts.Controllers.MedaraInfographicsController
{
    ...
    /// </summary>
    public class MedaraInfographicsEventManager
    {
        private MedaraInfographicsUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraInfographicsOps.PanelType> _onPanelTransitionComplete;
        private MedaraInfographicsOrchestrator _orchestrator;
        ...
        public MedaraInfographicsEventManager(
            MedaraInfographicsUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraInfographicsOps.PanelType> onPanelTransitionComplete, 
            MedaraInfographicsOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraInfographicsEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraInfographicsEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraInfographicsEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraInfographicsEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraInfographicsEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraInfographicsEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraInfographicsOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraInfographicsOrchestrator Orchestrator => _orchestrator;
