...
namespace _Scripts.Controllers.MedaraInfographicsController
{
    ...
    /// </summary>
    [System.Serializable]
    public class MedaraInfographicsInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraInfographicsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraInfographicsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraInfographicsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraInfographicsOps.PanelType CurrentActivePanel { get; set; } = IMedaraInfographicsOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraInfographics";
            ...
            // Eventos de estado
            public event Action<IMedaraInfographicsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraInfographicsOps.PanelType panelType)
            {
