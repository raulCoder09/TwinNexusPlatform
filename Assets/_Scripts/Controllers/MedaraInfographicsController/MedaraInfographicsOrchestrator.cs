...
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraInfographicsOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraInfographicsOrchestrator : MonoBehaviour, IMedaraInfographicsOps, IUIController
    {
        ...
        public string ControllerName => "MedaraInfographicsController";
        ...
        #region IMedaraInfographicsOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraInfographicsOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraInfographicsOps.PanelType.None;

        // Events from IMedaraInfographicsOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraInfographicsOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraInfographicsInfo.UIConfiguration _uiConfig = new MedaraInfographicsInfo.UIConfiguration();
        private MedaraInfographicsInfo.AwsConfiguration _awsConfig = new MedaraInfographicsInfo.AwsConfiguration();
        private MedaraInfographicsInfo.MedaraInfographicsState _settingsState = new MedaraInfographicsInfo.MedaraInfographicsState();
        
        private MedaraInfographicsUIManager _uiManager;
        private MedaraInfographicsEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraInfographicsOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraInfographicsOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraInfographicsOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraInfographicsUIManager...");
                _uiManager = new MedaraInfographicsUIManager(_uiConfig);
                Debug.Log("MedaraInfographicsUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraInfographicsEventManager...");
                _eventManager = new MedaraInfographicsEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraInfographicsEventManager created successfully");
                ...
                InitializeMedaraInfographicsState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraInfographicsOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraInfographicsOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraInfographicsOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraInfographicsOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraInfographicsOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraInfographicsOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraInfographicsOps.PanelType panelType)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "MedaraInfographics"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.NavigationMenu] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.AwsCredentials] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.ServiceConfig] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.TestResults] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.SecuritySettings] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.RegionSettings] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraInfographicsOps.PanelType.Help] = new MedaraInfographicsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraInfographicsState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraInfographics";
            _settingsState.CurrentActivePanel = IMedaraInfographicsOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraInfographicsInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraInfographicsOps.PanelType panelType)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraInfographicsInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraInfographicsUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraInfographicsEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraInfographicsInfo.MedaraInfographicsState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraInfographicsInfo.AwsConfiguration AwsConfig => _awsConfig;
