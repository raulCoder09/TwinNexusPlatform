...
{
    /// <summary>
    /// Interface que define las operaciones disponibles en el EdgeLocalBroker
    /// Similar a IWelcomeOps pero para navegación y acciones del EdgeLocalBroker
    /// </summary>
    public interface IEdgeLocalBrokerOps
    {
        ...
        // Operaciones específicas del EdgeLocalBroker
        ...
        /// <summary>
        /// Tipos de paneles disponibles en el EdgeLocalBroker
        /// </summary>
