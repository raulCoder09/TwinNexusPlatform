...
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IArScaraJogAndTeachOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class ArScaraJogAndTeachOrchestrator : MonoBehaviour, IArScaraJogAndTeachOps, IUIController
    {
        ...
        public string ControllerName => "ArScaraJogAndTeachController";
        ...
        #region IArScaraJogAndTeachOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IArScaraJogAndTeachOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IArScaraJogAndTeachOps.PanelType.None;

        // Events from IArScaraJogAndTeachOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IArScaraJogAndTeachOps.PanelType> OnPanelTransitionComplete;
        ...
        private ArScaraJogAndTeachInfo.UIConfiguration _uiConfig = new ArScaraJogAndTeachInfo.UIConfiguration();
        private ArScaraJogAndTeachInfo.AwsConfiguration _awsConfig = new ArScaraJogAndTeachInfo.AwsConfiguration();
        private ArScaraJogAndTeachInfo.ArScaraJogAndTeachState _settingsState = new ArScaraJogAndTeachInfo.ArScaraJogAndTeachState();
        
        private ArScaraJogAndTeachUIManager _uiManager;
        private ArScaraJogAndTeachEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[ArScaraJogAndTeachOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("ArScaraJogAndTeachOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing ArScaraJogAndTeachOrchestrator...");
                ...
                Debug.Log("Step 5: Creating ArScaraJogAndTeachUIManager...");
                _uiManager = new ArScaraJogAndTeachUIManager(_uiConfig);
                Debug.Log("ArScaraJogAndTeachUIManager created successfully");

                Debug.Log("Step 6: Creating ArScaraJogAndTeachEventManager...");
                _eventManager = new ArScaraJogAndTeachEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("ArScaraJogAndTeachEventManager created successfully");
                ...
                InitializeArScaraJogAndTeachState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("ArScaraJogAndTeachOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"ArScaraJogAndTeachOrchestrator initialization error: {ex.Message}");
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[ArScaraJogAndTeachOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[ArScaraJogAndTeachOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[ArScaraJogAndTeachOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IArScaraJogAndTeachOps.PanelType panelType)
        {
        ...
        public void SwitchPanel(IArScaraJogAndTeachOps.PanelType fromPanel, IArScaraJogAndTeachOps.PanelType toPanel)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "ArScaraJogAndTeach"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.NavigationMenu] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.AwsCredentials] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.ServiceConfig] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.TestResults] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.SecuritySettings] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.RegionSettings] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IArScaraJogAndTeachOps.PanelType.Help] = new ArScaraJogAndTeachInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeArScaraJogAndTeachState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "ArScaraJogAndTeach";
            _settingsState.CurrentActivePanel = IArScaraJogAndTeachOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, ArScaraJogAndTeachInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IArScaraJogAndTeachOps.PanelType panelType)
        {
        ...
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, ArScaraJogAndTeachInfo.ConnectionTestResult> results)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new ArScaraJogAndTeachInfo.ConnectionTestResult
            {
        ...
        /// </summary>
        public ArScaraJogAndTeachEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public ArScaraJogAndTeachInfo.ArScaraJogAndTeachState SettingsState => _settingsState;
