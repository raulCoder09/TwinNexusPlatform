...
namespace _Scripts.Controllers.ArScaraJogAndTeachController
{
    ...
    /// </summary>
    public class ArScaraJogAndTeachUIManager
    {
        private ArScaraJogAndTeachInfo.UIConfiguration _uiConfig;
        private IArScaraJogAndTeachOps.PanelType _currentActivePanel = IArScaraJogAndTeachOps.PanelType.None;
        ...
        public ArScaraJogAndTeachUIManager(ArScaraJogAndTeachInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[ArScaraJogAndTeachUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[ArScaraJogAndTeachUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[ArScaraJogAndTeachUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IArScaraJogAndTeachOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IArScaraJogAndTeachOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[ArScaraJogAndTeachUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IArScaraJogAndTeachOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[ArScaraJogAndTeachUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IArScaraJogAndTeachOps.PanelType panelType)
        {
            if (panelType == IArScaraJogAndTeachOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IArScaraJogAndTeachOps.PanelType.None && 
                _currentActivePanel != IArScaraJogAndTeachOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[ArScaraJogAndTeachUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IArScaraJogAndTeachOps.PanelType panelType)
        {
            if (panelType == IArScaraJogAndTeachOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[ArScaraJogAndTeachUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IArScaraJogAndTeachOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IArScaraJogAndTeachOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IArScaraJogAndTeachOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[ArScaraJogAndTeachUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[ArScaraJogAndTeachUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[ArScaraJogAndTeachUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IArScaraJogAndTeachOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[ArScaraJogAndTeachUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IArScaraJogAndTeachOps.PanelType CurrentActivePanel => _currentActivePanel;
