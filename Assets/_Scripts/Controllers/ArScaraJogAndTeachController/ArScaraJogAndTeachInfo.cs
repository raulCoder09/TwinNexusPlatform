...
namespace _Scripts.Controllers.ArScaraJogAndTeachController
{
    ...
    /// </summary>
    [System.Serializable]
    public class ArScaraJogAndTeachInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IArScaraJogAndTeachOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IArScaraJogAndTeachOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class ArScaraJogAndTeachState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IArScaraJogAndTeachOps.PanelType CurrentActivePanel { get; set; } = IArScaraJogAndTeachOps.PanelType.None;
            public string CurrentSection { get; set; } = "ArScaraJogAndTeach";
            ...
            // Eventos de estado
            public event Action<IArScaraJogAndTeachOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IArScaraJogAndTeachOps.PanelType panelType)
            {
