...
namespace _Scripts.Controllers.ArScaraPointsController
{
    ...
    /// </summary>
    public class ArScaraPointsUIManager
    {
        private ArScaraPointsInfo.UIConfiguration _uiConfig;
        private IArScaraPointsOps.PanelType _currentActivePanel = IArScaraPointsOps.PanelType.None;
        ...
        public ArScaraPointsUIManager(ArScaraPointsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[ArScaraPointsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[ArScaraPointsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[ArScaraPointsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IArScaraPointsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IArScaraPointsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[ArScaraPointsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IArScaraPointsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[ArScaraPointsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IArScaraPointsOps.PanelType panelType)
        {
            if (panelType == IArScaraPointsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IArScaraPointsOps.PanelType.None && 
                _currentActivePanel != IArScaraPointsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[ArScaraPointsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IArScaraPointsOps.PanelType panelType)
        {
            if (panelType == IArScaraPointsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[ArScaraPointsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IArScaraPointsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IArScaraPointsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IArScaraPointsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[ArScaraPointsUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[ArScaraPointsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[ArScaraPointsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IArScaraPointsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[ArScaraPointsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IArScaraPointsOps.PanelType CurrentActivePanel => _currentActivePanel;
