...
namespace _Scripts.Controllers.MedaraDocumentsController
{
    ...
    /// </summary>
    public class MedaraDocumentsUIManager
    {
        private MedaraDocumentsInfo.UIConfiguration _uiConfig;
        private IMedaraDocumentsOps.PanelType _currentActivePanel = IMedaraDocumentsOps.PanelType.None;
        ...
        public MedaraDocumentsUIManager(MedaraDocumentsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[MedaraDocumentsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[MedaraDocumentsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[MedaraDocumentsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IMedaraDocumentsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IMedaraDocumentsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[MedaraDocumentsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IMedaraDocumentsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[MedaraDocumentsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IMedaraDocumentsOps.PanelType panelType)
        {
            if (panelType == IMedaraDocumentsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IMedaraDocumentsOps.PanelType.None && 
                _currentActivePanel != IMedaraDocumentsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[MedaraDocumentsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IMedaraDocumentsOps.PanelType panelType)
        {
            if (panelType == IMedaraDocumentsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[MedaraDocumentsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IMedaraDocumentsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IMedaraDocumentsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IMedaraDocumentsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[MedaraDocumentsUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraDocumentsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraDocumentsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IMedaraDocumentsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[MedaraDocumentsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IMedaraDocumentsOps.PanelType CurrentActivePanel => _currentActivePanel;
