...
namespace _Scripts.Controllers.MedaraDocumentsController
{
    ...
    /// </summary>
    public class MedaraDocumentsEventManager
    {
        private MedaraDocumentsUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraDocumentsOps.PanelType> _onPanelTransitionComplete;
        private MedaraDocumentsOrchestrator _orchestrator;
        ...
        public MedaraDocumentsEventManager(
            MedaraDocumentsUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraDocumentsOps.PanelType> onPanelTransitionComplete, 
            MedaraDocumentsOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraDocumentsEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraDocumentsEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraDocumentsEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraDocumentsEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraDocumentsEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraDocumentsEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraDocumentsOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraDocumentsOrchestrator Orchestrator => _orchestrator;
