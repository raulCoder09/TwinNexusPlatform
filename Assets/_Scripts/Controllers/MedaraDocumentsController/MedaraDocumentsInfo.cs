...
namespace _Scripts.Controllers.MedaraDocumentsController
{
    ...
    /// </summary>
    [System.Serializable]
    public class MedaraDocumentsInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraDocumentsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraDocumentsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraDocumentsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraDocumentsOps.PanelType CurrentActivePanel { get; set; } = IMedaraDocumentsOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraDocuments";
            ...
            // Eventos de estado
            public event Action<IMedaraDocumentsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraDocumentsOps.PanelType panelType)
            {
