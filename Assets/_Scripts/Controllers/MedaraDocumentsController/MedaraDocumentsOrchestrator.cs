...
namespace _Scripts.Controllers.MedaraDocumentsController
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraDocumentsOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraDocumentsOrchestrator : MonoBehaviour, IMedaraDocumentsOps, IUIController
    {
        ...
        public string ControllerName => "MedaraDocumentsController";
        ...
        #region IMedaraDocumentsOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraDocumentsOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraDocumentsOps.PanelType.None;

        // Events from IMedaraDocumentsOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraDocumentsOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraDocumentsInfo.UIConfiguration _uiConfig = new MedaraDocumentsInfo.UIConfiguration();
        private MedaraDocumentsInfo.AwsConfiguration _awsConfig = new MedaraDocumentsInfo.AwsConfiguration();
        private MedaraDocumentsInfo.MedaraDocumentsState _settingsState = new MedaraDocumentsInfo.MedaraDocumentsState();
        
        private MedaraDocumentsUIManager _uiManager;
        private MedaraDocumentsEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraDocumentsOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraDocumentsOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraDocumentsOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraDocumentsUIManager...");
                _uiManager = new MedaraDocumentsUIManager(_uiConfig);
                Debug.Log("MedaraDocumentsUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraDocumentsEventManager...");
                _eventManager = new MedaraDocumentsEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraDocumentsEventManager created successfully");
                ...
                InitializeMedaraDocumentsState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraDocumentsOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraDocumentsOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraDocumentsOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraDocumentsOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraDocumentsOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraDocumentsOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraDocumentsOps.PanelType panelType)
        {
        ...
        public void SwitchPanel(IMedaraDocumentsOps.PanelType fromPanel, IMedaraDocumentsOps.PanelType toPanel)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "MedaraDocuments"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.NavigationMenu] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.AwsCredentials] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.ServiceConfig] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.TestResults] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.SecuritySettings] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.RegionSettings] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraDocumentsOps.PanelType.Help] = new MedaraDocumentsInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraDocumentsState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraDocuments";
            _settingsState.CurrentActivePanel = IMedaraDocumentsOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraDocumentsInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraDocumentsOps.PanelType panelType)
        {
        ...
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, MedaraDocumentsInfo.ConnectionTestResult> results)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraDocumentsInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraDocumentsUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraDocumentsEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraDocumentsInfo.MedaraDocumentsState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraDocumentsInfo.AwsConfiguration AwsConfig => _awsConfig;
