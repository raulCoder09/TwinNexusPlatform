...
namespace _Scripts.Controllers.SESSettingsController
{
    ...
    public class SESSettingsInfo
    {
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<ISESSettingsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<ISESSettingsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class SESSettingsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public ISESSettingsOps.PanelType CurrentActivePanel { get; set; } = ISESSettingsOps.PanelType.None;
            public string CurrentSection { get; set; } = "SESSettings";
            ...
            // Eventos de estado
            public event Action<ISESSettingsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(ISESSettingsOps.PanelType panelType)
            {
