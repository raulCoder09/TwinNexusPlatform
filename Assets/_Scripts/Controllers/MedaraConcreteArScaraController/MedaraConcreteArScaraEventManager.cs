...
namespace _Scripts.Controllers.MedaraConcreteArScaraController
{
    ...
    /// </summary>
    public class MedaraConcreteArScaraEventManager
    {
        private MedaraConcreteArScaraUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraConcreteArScaraOps.PanelType> _onPanelTransitionComplete;
        private MedaraConcreteArScaraOrchestrator _orchestrator;
        ...
        public MedaraConcreteArScaraEventManager(
            MedaraConcreteArScaraUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraConcreteArScaraOps.PanelType> onPanelTransitionComplete, 
            MedaraConcreteArScaraOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraConcreteArScaraEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraConcreteArScaraEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraConcreteArScaraEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraConcreteArScaraEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraConcreteArScaraEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraConcreteArScaraEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraConcreteArScaraOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraConcreteArScaraOrchestrator Orchestrator => _orchestrator;
