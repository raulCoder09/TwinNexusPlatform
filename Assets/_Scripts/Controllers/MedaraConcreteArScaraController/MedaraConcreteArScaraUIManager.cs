...
namespace _Scripts.Controllers.MedaraConcreteArScaraController
{
    ...
    /// </summary>
    public class MedaraConcreteArScaraUIManager
    {
        private MedaraConcreteArScaraInfo.UIConfiguration _uiConfig;
        private IMedaraConcreteArScaraOps.PanelType _currentActivePanel = IMedaraConcreteArScaraOps.PanelType.None;
        ...
        public MedaraConcreteArScaraUIManager(MedaraConcreteArScaraInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[MedaraConcreteArScaraUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[MedaraConcreteArScaraUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[MedaraConcreteArScaraUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IMedaraConcreteArScaraOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IMedaraConcreteArScaraOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[MedaraConcreteArScaraUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IMedaraConcreteArScaraOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[MedaraConcreteArScaraUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IMedaraConcreteArScaraOps.PanelType panelType)
        {
            if (panelType == IMedaraConcreteArScaraOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IMedaraConcreteArScaraOps.PanelType.None && 
                _currentActivePanel != IMedaraConcreteArScaraOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[MedaraConcreteArScaraUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IMedaraConcreteArScaraOps.PanelType panelType)
        {
            if (panelType == IMedaraConcreteArScaraOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[MedaraConcreteArScaraUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IMedaraConcreteArScaraOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IMedaraConcreteArScaraOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IMedaraConcreteArScaraOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[MedaraConcreteArScaraUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraConcreteArScaraUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[MedaraConcreteArScaraUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IMedaraConcreteArScaraOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[MedaraConcreteArScaraUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IMedaraConcreteArScaraOps.PanelType CurrentActivePanel => _currentActivePanel;
