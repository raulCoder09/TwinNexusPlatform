...
namespace _Scripts.Controllers.MedaraConcreteArScaraController
{
    ...
    /// </summary>
    [System.Serializable]
    public class MedaraConcreteArScaraInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraConcreteArScaraOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraConcreteArScaraOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraConcreteArScaraState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraConcreteArScaraOps.PanelType CurrentActivePanel { get; set; } = IMedaraConcreteArScaraOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraConcreteArScara";
            ...
            // Eventos de estado
            public event Action<IMedaraConcreteArScaraOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraConcreteArScaraOps.PanelType panelType)
            {
