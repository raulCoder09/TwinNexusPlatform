...
namespace _Scripts.Controllers.MedaraConcreteArScaraController
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraConcreteArScaraOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraConcreteArScaraOrchestrator : MonoBehaviour, IMedaraConcreteArScaraOps, IUIController
    {
        ...
        public string ControllerName => "MedaraConcreteArScaraController";
        ...
        #region IMedaraConcreteArScaraOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraConcreteArScaraOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraConcreteArScaraOps.PanelType.None;

        // Events from IMedaraConcreteArScaraOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraConcreteArScaraOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraConcreteArScaraInfo.UIConfiguration _uiConfig = new MedaraConcreteArScaraInfo.UIConfiguration();
        private MedaraConcreteArScaraInfo.AwsConfiguration _awsConfig = new MedaraConcreteArScaraInfo.AwsConfiguration();
        private MedaraConcreteArScaraInfo.MedaraConcreteArScaraState _settingsState = new MedaraConcreteArScaraInfo.MedaraConcreteArScaraState();
        
        private MedaraConcreteArScaraUIManager _uiManager;
        private MedaraConcreteArScaraEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraConcreteArScaraOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraConcreteArScaraOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraConcreteArScaraOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraConcreteArScaraUIManager...");
                _uiManager = new MedaraConcreteArScaraUIManager(_uiConfig);
                Debug.Log("MedaraConcreteArScaraUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraConcreteArScaraEventManager...");
                _eventManager = new MedaraConcreteArScaraEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraConcreteArScaraEventManager created successfully");
                ...
                InitializeMedaraConcreteArScaraState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraConcreteArScaraOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraConcreteArScaraOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraConcreteArScaraOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraConcreteArScaraOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraConcreteArScaraOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraConcreteArScaraOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraConcreteArScaraOps.PanelType panelType)
        {
        ...
        public void SwitchPanel(IMedaraConcreteArScaraOps.PanelType fromPanel, IMedaraConcreteArScaraOps.PanelType toPanel)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "MedaraConcreteArScara"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.NavigationMenu] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.AwsCredentials] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.ServiceConfig] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.TestResults] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.SecuritySettings] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.RegionSettings] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraConcreteArScaraOps.PanelType.Help] = new MedaraConcreteArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraConcreteArScaraState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraConcreteArScara";
            _settingsState.CurrentActivePanel = IMedaraConcreteArScaraOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraConcreteArScaraInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraConcreteArScaraOps.PanelType panelType)
        {
        ...
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, MedaraConcreteArScaraInfo.ConnectionTestResult> results)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraConcreteArScaraInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraConcreteArScaraUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraConcreteArScaraEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraConcreteArScaraInfo.MedaraConcreteArScaraState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraConcreteArScaraInfo.AwsConfiguration AwsConfig => _awsConfig;
