...
namespace _Scripts.Controllers.LambdaSettingsController
{
    ...
    /// </summary>
    public class LambdaSettingsUIManager
    {
        private LambdaSettingsInfo.UIConfiguration _uiConfig;
        private ILambdaSettingsOps.PanelType _currentActivePanel = ILambdaSettingsOps.PanelType.None;
        ...
        public LambdaSettingsUIManager(LambdaSettingsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[LambdaSettingsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[LambdaSettingsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[LambdaSettingsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(ILambdaSettingsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = ILambdaSettingsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[LambdaSettingsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = ILambdaSettingsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[LambdaSettingsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(ILambdaSettingsOps.PanelType panelType)
        {
            if (panelType == ILambdaSettingsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != ILambdaSettingsOps.PanelType.None && 
                _currentActivePanel != ILambdaSettingsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[LambdaSettingsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(ILambdaSettingsOps.PanelType panelType)
        {
            if (panelType == ILambdaSettingsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[LambdaSettingsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != ILambdaSettingsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != ILambdaSettingsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(ILambdaSettingsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[LambdaSettingsUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[LambdaSettingsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[LambdaSettingsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != ILambdaSettingsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[LambdaSettingsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public ILambdaSettingsOps.PanelType CurrentActivePanel => _currentActivePanel;
