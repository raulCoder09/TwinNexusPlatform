...
namespace _Scripts.Controllers.LambdaSettingsController
{
    ...
    /// </summary>
    [System.Serializable]
    public class LambdaSettingsInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<ILambdaSettingsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<ILambdaSettingsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class LambdaSettingsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public ILambdaSettingsOps.PanelType CurrentActivePanel { get; set; } = ILambdaSettingsOps.PanelType.None;
            public string CurrentSection { get; set; } = "LambdaSettings";
            ...
            // Eventos de estado
            public event Action<ILambdaSettingsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(ILambdaSettingsOps.PanelType panelType)
            {
