...
namespace _Scripts.Controllers.MedaraGraphicArScaraController
{
    ...
    /// </summary>
    public class MedaraGraphicArScaraEventManager
    {
        private MedaraGraphicArScaraUIManager _uiManager;
        private Action _onReturnToDashboard;
        private Action<IMedaraGraphicArScaraOps.PanelType> _onPanelTransitionComplete;
        private MedaraGraphicArScaraOrchestrator _orchestrator;
        ...
        public MedaraGraphicArScaraEventManager(
            MedaraGraphicArScaraUIManager uiManager, 
            Action onReturnToDashboard, 
            Action<IMedaraGraphicArScaraOps.PanelType> onPanelTransitionComplete, 
            MedaraGraphicArScaraOrchestrator orchestrator)
        {
        ...
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[MedaraGraphicArScaraEventManager] All events registered successfully");
        }
        ...
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[MedaraGraphicArScaraEventManager] Unregistering AWS Settings events...");

                if (_root == null)
                {
                    Debug.LogWarning("[MedaraGraphicArScaraEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[MedaraGraphicArScaraEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraGraphicArScaraEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[MedaraGraphicArScaraEventManager] Event Manager cleaned up");
        }
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IMedaraGraphicArScaraOps.PanelType.None)
            {
        ...
        /// </summary>
        public MedaraGraphicArScaraOrchestrator Orchestrator => _orchestrator;
