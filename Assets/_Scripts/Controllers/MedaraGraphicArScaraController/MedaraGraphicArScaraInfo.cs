...
namespace _Scripts.Controllers.MedaraGraphicArScaraController
{
    ...
    /// </summary>
    [System.Serializable]
    public class MedaraGraphicArScaraInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IMedaraGraphicArScaraOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IMedaraGraphicArScaraOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class MedaraGraphicArScaraState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IMedaraGraphicArScaraOps.PanelType CurrentActivePanel { get; set; } = IMedaraGraphicArScaraOps.PanelType.None;
            public string CurrentSection { get; set; } = "MedaraGraphicArScara";
            ...
            // Eventos de estado
            public event Action<IMedaraGraphicArScaraOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IMedaraGraphicArScaraOps.PanelType panelType)
            {
