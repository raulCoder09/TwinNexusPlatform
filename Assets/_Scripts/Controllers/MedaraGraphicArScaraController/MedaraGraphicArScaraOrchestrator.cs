...
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IMedaraGraphicArScaraOps e IUIController
    /// Equivalente a DashboardOrchestrator pero para configuraciones AWS
    /// </summary>
    public class MedaraGraphicArScaraOrchestrator : MonoBehaviour, IMedaraGraphicArScaraOps, IUIController
    {
        ...
        public string ControllerName => "MedaraGraphicArScaraController";
        ...
        #region IMedaraGraphicArScaraOps Implementation

        public bool IsNavigationMenuOpen => _uiManager?.NavigationMenuOpen ?? false;
        public IMedaraGraphicArScaraOps.PanelType CurrentActivePanel => _uiManager?.CurrentActivePanel ?? IMedaraGraphicArScaraOps.PanelType.None;

        // Events from IMedaraGraphicArScaraOps
        public event Action OnNavigationMenuOpened;
        public event Action OnNavigationMenuClosed;
        public event Action<IMedaraGraphicArScaraOps.PanelType> OnPanelTransitionComplete;
        ...
        private MedaraGraphicArScaraInfo.UIConfiguration _uiConfig = new MedaraGraphicArScaraInfo.UIConfiguration();
        private MedaraGraphicArScaraInfo.AwsConfiguration _awsConfig = new MedaraGraphicArScaraInfo.AwsConfiguration();
        private MedaraGraphicArScaraInfo.MedaraGraphicArScaraState _settingsState = new MedaraGraphicArScaraInfo.MedaraGraphicArScaraState();
        
        private MedaraGraphicArScaraUIManager _uiManager;
        private MedaraGraphicArScaraEventManager _eventManager;
        ...
        private void Start()
        {
            ...
            Debug.Log("[MedaraGraphicArScaraOrchestrator] Started - UI hidden until navigation");
        }
        ...
        public bool Initialize()
        {
            try
            {
                if (_isInitialized)
                {
                    Debug.Log("MedaraGraphicArScaraOrchestrator already initialized");
                    return true;
                }

                Debug.Log("Initializing MedaraGraphicArScaraOrchestrator...");
                ...
                Debug.Log("Step 5: Creating MedaraGraphicArScaraUIManager...");
                _uiManager = new MedaraGraphicArScaraUIManager(_uiConfig);
                Debug.Log("MedaraGraphicArScaraUIManager created successfully");

                Debug.Log("Step 6: Creating MedaraGraphicArScaraEventManager...");
                _eventManager = new MedaraGraphicArScaraEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("MedaraGraphicArScaraEventManager created successfully");
                ...
                InitializeMedaraGraphicArScaraState();
                Debug.Log("AWS settings state initialized");

                _isInitialized = true;
                Debug.Log("MedaraGraphicArScaraOrchestrator initialized successfully");
            ...
            {
                Debug.LogError($"MedaraGraphicArScaraOrchestrator initialization error: {ex.Message}");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraGraphicArScaraOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[MedaraGraphicArScaraOrchestrator] AWS Settings UI hidden");
            }
        }
        ...
        public void Cleanup()
        {
            try
            {
                ...
                Debug.Log("[MedaraGraphicArScaraOrchestrator] Cleanup completed");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[MedaraGraphicArScaraOrchestrator] Cleanup error: {ex.Message}");
            }
        }
        ...
        public void NavigateToPanel(IMedaraGraphicArScaraOps.PanelType panelType)
        {
        ...
        public void HandleOperationsClick()
        {
            var parameters = new Dictionary<string, object> {
                ["context"] = "Operations", 
                ["sourceController"] = "MedaraGraphicArScara"
            };
        ...
        private void InitializePanelConfiguration(VisualElement root)
        {
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.NavigationMenu] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.AwsCredentials] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.ServiceConfig] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.TestResults] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.SecuritySettings] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.RegionSettings] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
            ...
            _uiConfig.Panels[IMedaraGraphicArScaraOps.PanelType.Help] = new MedaraGraphicArScaraInfo.UIConfiguration.PanelData
            {
                Panel = null, // Será null porque no existe en UXML
        ...
        /// </summary>
        private void InitializeMedaraGraphicArScaraState()
        {
            _settingsState.IsInitialized = true;
            _settingsState.CurrentSection = "MedaraGraphicArScara";
            _settingsState.CurrentActivePanel = IMedaraGraphicArScaraOps.PanelType.None;
            ...
            _awsConfig.TestResults = new Dictionary<string, MedaraGraphicArScaraInfo.ConnectionTestResult>();
        ...
        /// </summary>
        private void OnPanelTransitionCompleteHandler(IMedaraGraphicArScaraOps.PanelType panelType)
        {
        ...
        public void TestServiceConnection(string serviceName)
        {
            ...
            var testResult = new MedaraGraphicArScaraInfo.ConnectionTestResult
            {
        ...
        /// UI Manager asociado
        /// </summary>
        public MedaraGraphicArScaraUIManager UIManager => _uiManager;

        /// <summary>
        /// Event Manager asociado
        /// </summary>
        public MedaraGraphicArScaraEventManager EventManager => _eventManager;

        /// <summary>
        /// Estado actual de AWS Settings
        /// </summary>
        public MedaraGraphicArScaraInfo.MedaraGraphicArScaraState SettingsState => _settingsState;

        /// <summary>
        /// Configuración AWS actual
        /// </summary>
        public MedaraGraphicArScaraInfo.AwsConfiguration AwsConfig => _awsConfig;
