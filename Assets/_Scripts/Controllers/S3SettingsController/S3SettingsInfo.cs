...
namespace _Scripts.Controllers.S3SettingsController
{
    ...
    public class S3SettingsInfo
    {
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IS3SettingsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IS3SettingsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class S3SettingsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IS3SettingsOps.PanelType CurrentActivePanel { get; set; } = IS3SettingsOps.PanelType.None;
            public string CurrentSection { get; set; } = "S3Settings";
            ...
            // Eventos de estado
            public event Action<IS3SettingsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IS3SettingsOps.PanelType panelType)
            {
