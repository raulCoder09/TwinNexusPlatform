...
namespace _Scripts.Controllers.S3SettingsController
{
    ...
    /// </summary>
    public class S3SettingsUIManager
    {
        private S3SettingsInfo.UIConfiguration _uiConfig;
        private IS3SettingsOps.PanelType _currentActivePanel = IS3SettingsOps.PanelType.None;
        ...
        public S3SettingsUIManager(S3SettingsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[S3SettingsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[S3SettingsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[S3SettingsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IS3SettingsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IS3SettingsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[S3SettingsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IS3SettingsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[S3SettingsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IS3SettingsOps.PanelType panelType)
        {
            if (panelType == IS3SettingsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IS3SettingsOps.PanelType.None && 
                _currentActivePanel != IS3SettingsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[S3SettingsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IS3SettingsOps.PanelType panelType)
        {
            if (panelType == IS3SettingsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[S3SettingsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IS3SettingsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IS3SettingsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IS3SettingsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[S3SettingsUIManager] Credentials status updated: {isValid} - {message}");
        }

        /// <summary>
        /// Actualiza resultados de pruebas de conexión
        /// </summary>
        public void UpdateConnectionTestResults(Dictionary<string, S3SettingsInfo.ConnectionTestResult> results)
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[S3SettingsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[S3SettingsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IS3SettingsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[S3SettingsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IS3SettingsOps.PanelType CurrentActivePanel => _currentActivePanel;
