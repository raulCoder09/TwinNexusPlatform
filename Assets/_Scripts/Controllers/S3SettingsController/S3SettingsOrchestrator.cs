...
{
    /// <summary>
    /// Coordinador principal de AWS Settings - implementa IS3SettingsOps e IUIController
    ...
    public class S3SettingsOrchestrator : MonoBehaviour, IS3SettingsOps, IUIController
    {
        ...
        public bool Initialize()
        {
            try
            {
                ...
                Debug.Log("Step 5: Creating S3SettingsUIManager...");
                _uiManager = new S3SettingsUIManager(_uiConfig);
                Debug.Log("S3SettingsUIManager created successfully");

                Debug.Log("Step 6: Creating S3SettingsEventManager...");
                _eventManager = new S3SettingsEventManager(_uiManager, OnReturnToDashboardHandler, OnPanelTransitionCompleteHandler, this);
                Debug.Log("S3SettingsEventManager created successfully");
        ...
        public void Show()
        {
            ...
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[S3SettingsOrchestrator] AWS Settings UI shown");
            }
        }
        ...
        public void Hide()
        {
            if (_uiConfig?.Body != null)
            {
                ...
                Debug.Log("[S3SettingsOrchestrator] AWS Settings UI hidden");
            }
        }
