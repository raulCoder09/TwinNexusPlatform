...
namespace _Scripts.Controllers.IotCoreSettingsController
{
    ...
    /// </summary>
    public class IotCoreSettingsUIManager
    {
        private IotCoreSettingsInfo.UIConfiguration _uiConfig;
        private IIotCoreSettingsOps.PanelType _currentActivePanel = IIotCoreSettingsOps.PanelType.None;
        ...
        public IotCoreSettingsUIManager(IotCoreSettingsInfo.UIConfiguration uiConfig)
        {
        ...
        public void InitializePanelSystem()
        {
            ...
            Debug.Log("[IotCoreSettingsUIManager] Panel system initialized");
        }
        ...
        public void ShowUi()
        {
            ...
            Debug.Log("[IotCoreSettingsUIManager] AWS Settings UI shown");
        }
        ...
        public void HideUi()
        {
            ...
            CloseAllPanels();
            Debug.Log("[IotCoreSettingsUIManager] AWS Settings UI hidden");
        }
        ...
        public void ShowNavigationMenu()
        {
            ...
            if (!_uiConfig.Panels.TryGetValue(IIotCoreSettingsOps.PanelType.NavigationMenu, out var menuPanel))
            {
            ...
            _currentActivePanel = IIotCoreSettingsOps.PanelType.NavigationMenu;
            _isNavigationMenuOpen = true;
    
            Debug.Log("[IotCoreSettingsUIManager] Navigation menu opened");
        }
        ...
        public void HideNavigationMenu()
        {
            ...
            _currentActivePanel = IIotCoreSettingsOps.PanelType.None;
            _isNavigationMenuOpen = false;
    
            Debug.Log("[IotCoreSettingsUIManager] Navigation menu closed");
        }
        ...
        /// </summary>
        public void ShowPanel(IIotCoreSettingsOps.PanelType panelType)
        {
            if (panelType == IIotCoreSettingsOps.PanelType.NavigationMenu)
            {
                ShowNavigationMenu();
                return;
            }
            ...
            if (_currentActivePanel != IIotCoreSettingsOps.PanelType.None && 
                _currentActivePanel != IIotCoreSettingsOps.PanelType.NavigationMenu)
            {
            ...
            Debug.Log($"[IotCoreSettingsUIManager] Panel {panelType} opened");
        }

        /// <summary>
        /// Oculta un panel específico
        /// </summary>
        public void HidePanel(IIotCoreSettingsOps.PanelType panelType)
        {
            if (panelType == IIotCoreSettingsOps.PanelType.NavigationMenu)
            {
                HideNavigationMenu();
            ...
            Debug.Log($"[IotCoreSettingsUIManager] Panel {panelType} closed");
        }
        ...
        {
            if (fromPanel != IIotCoreSettingsOps.PanelType.None)
            {
                HidePanel(fromPanel);
            }
            
            if (toPanel != IIotCoreSettingsOps.PanelType.None)
            {
                ShowPanel(toPanel);
            }
        }
        ...
        /// </summary>
        private bool HasOtherPanelsRequiringScrim(IIotCoreSettingsOps.PanelType excludePanel)
        {
            foreach (var kvp in _uiConfig.Panels)
            {
        ...
        public void UpdateCredentialsStatus(bool isValid, string message = null)
        {
            ...
            Debug.Log($"[IotCoreSettingsUIManager] Credentials status updated: {isValid} - {message}");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[IotCoreSettingsUIManager] Connection test results updated for {results.Count} services");
        }
        ...
        {
            // TODO: Implementar cuando se agregue contenido al Main
            Debug.Log($"[IotCoreSettingsUIManager] Service states updated for {serviceStates.Count} services");
        }
        ...
        private void ClearAllPanelStates()
        {
            foreach (var kvp in _uiConfig.Panels)
            {
                ...
                if (panelData.Panel != null)
                {
                    ...
                    if (kvp.Key != IIotCoreSettingsOps.PanelType.NavigationMenu)
                    {
        ...
        private void OnPanelTransitionComplete(TransitionEndEvent evt)
        {
            ...
            {
                _uiConfig.SubpanelsContainer.style.display = DisplayStyle.None;
                Debug.Log("[IotCoreSettingsUIManager] All panels closed - hiding container");
            }
        }
        ...
        /// </summary>
        public IIotCoreSettingsOps.PanelType CurrentActivePanel => _currentActivePanel;
