...
namespace _Scripts.Controllers.IotCoreSettingsController
{
    ...
    /// </summary>
    [System.Serializable]
    public class IotCoreSettingsInfo
    {
        /// <summary>
        ...
        public class UIConfiguration
        {
            ...
            public Dictionary<IIotCoreSettingsOps.PanelType, PanelData> Panels { get; set; } 
                = new Dictionary<IIotCoreSettingsOps.PanelType, PanelData>();
        ...
        /// </summary>
        public class IotCoreSettingsState
        {
            public bool IsInitialized { get; set; }
            public bool IsNavigationMenuOpen { get; set; }
            public IIotCoreSettingsOps.PanelType CurrentActivePanel { get; set; } = IIotCoreSettingsOps.PanelType.None;
            public string CurrentSection { get; set; } = "IotCoreSettings";
            ...
            // Eventos de estado
            public event Action<IIotCoreSettingsOps.PanelType> OnPanelChanged;
            ...
            public void TriggerPanelChanged(IIotCoreSettingsOps.PanelType panelType)
            {
