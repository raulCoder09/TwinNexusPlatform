...
{
    /// <summary>
    /// Maneja todos los eventos UI del ManagedCloudService
    /// Equivalente a WelcomeEventManager pero para ManagedCloudService
    /// </summary>
    public class ManagedCloudServiceEventManager
    {
        private ManagedCloudServiceUIManager _uiManager;
        private Action _onLogoutRequested;
        private Action<IManagedCloudServiceOps.PanelType> _onPanelTransitionComplete;
        private ManagedCloudServiceOrchestrator _orchestrator;
        ...
        public ManagedCloudServiceEventManager(
            ManagedCloudServiceUIManager uiManager, 
            Action onLogoutRequested, 
            Action<IManagedCloudServiceOps.PanelType> onPanelTransitionComplete, 
            ManagedCloudServiceOrchestrator orchestrator)
        {
        ...
        /// <summary>
        /// Registra todos los eventos del ManagedCloudService
        /// </summary>
        public void RegisterEvents(UIDocument uiDocument)
        {
            ...
            Debug.Log("[ManagedCloudServiceEventManager] All events registered successfully");
        }

        /// <summary>
        /// Desregistra todos los eventos del ManagedCloudService
        /// </summary>
        public void UnregisterEvents()
        {
            try
            {
                Debug.Log("[ManagedCloudServiceEventManager] Unregistering ManagedCloudService events...");

                if (_root == null)
                {
                    Debug.LogWarning("[ManagedCloudServiceEventManager] Root element is null - cannot unregister events");
                    return;
                }
                ...
                Debug.Log("[ManagedCloudServiceEventManager] All events unregistered successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[ManagedCloudServiceEventManager] Error unregistering events: {ex.Message}");
            }
        }
        ...
        public void Cleanup()
        {
            ...
            Debug.Log("[ManagedCloudServiceEventManager] Event Manager cleaned up");
        }
        ...
        /// <summary>
        /// Registra eventos de teclado para el ManagedCloudService
        /// </summary>
        ...
        private async void HandleEscapeKey()
        {
            ...
            if (_uiManager.CurrentActivePanel != IManagedCloudServiceOps.PanelType.None)
            {
        ...
        private async void OnMenuButtonClicked(ClickEvent evt)
        {
            ...
            await UIAnalyticsManager.Instance?.TrackMenuEvent(
                action: "menu_opened",
                menuItem: null,
                context: "ManagedCloudService_main"
            );
        }
        ...
        {
            _uiManager.ShowPanel(IManagedCloudServiceOps.PanelType.Notifications);
            await UIAnalyticsManager.Instance?.TrackPanelTransition(
                fromPanel: "ManagedCloudService_main",
        ...
        {
            _uiManager.ShowPanel(IManagedCloudServiceOps.PanelType.UserProfile);
        }
        ...
        {
            _uiManager.ShowPanel(IManagedCloudServiceOps.PanelType.QuickActions);
        }
        ...
        {
            _uiManager.ShowPanel(IManagedCloudServiceOps.PanelType.StatusOverlay);
        }
        ...
        {
            _uiManager.HidePanel(IManagedCloudServiceOps.PanelType.Notifications);
            await UIAnalyticsManager.Instance?.TrackPanelTransition(
        ...
        {
            _uiManager.HidePanel(IManagedCloudServiceOps.PanelType.UserProfile);
        }
        ...
        {
            _uiManager.HidePanel(IManagedCloudServiceOps.PanelType.QuickActions);
        }
        ...
        {
            _uiManager.HidePanel(IManagedCloudServiceOps.PanelType.StatusOverlay);
        }
